...
public class WelcomePage {
    public WelcomePage() {
        ...
        ImageIcon logoImgRaw = new ImageIcon((Links.APP_LOGO_WOBG.getFilePath()));
        ...
        ImageIcon ImageTempRaw = new ImageIcon(Links.STAGE_CONTENT.getFilePath());
        ...
        regBtn.addActionListener(e -> {
            try {
                WelcomeControl.getActionButton("GO_TO_EVENT_PAGE", frame);
        ...
        extBtn.addActionListener(e -> {
            try {
                WelcomeControl.getActionButton("EXIT_PROGRAM", frame);
            } catch (RemoteException ex) {
                throw new RuntimeException(ex);
            }
        });
